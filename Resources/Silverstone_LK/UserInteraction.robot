*** Keywords ***
MtEcho_prepare_fct_new
    log.debug               Interaction Initialize prepare unit.
    USER_INTERACTION        title=Inserted QSFP, DAC cable and USB and PSU.
    ...             question_msg=Inserted QSFP, DAC cable and USB and PSU.
    ...             image_name=MtEcho_prepare_fct_MS.jpg      retry=12h      retry_interval=2s
    ...             html=user_interaction.html
    ...             pass_msg=Operator Inserted QSFP, DAC cable and USB and PSU Pass.
    ...             fail_msg=Operator Inserted QSFP, DAC cable and USB and PSU Fail.
    Sleep      1  
...
MtEcho_psu2_remove
    log.debug               Interaction Unplug PSU2.
    USER_INTERACTION        title=REMOVE PSU2.
    ...             question_msg=PLEASE REMOVE PSU2.
    ...             image_name=psu2remove.jpg      retry=12h      retry_interval=2s
    ...             html=user_interaction.html
    ...             pass_msg=Operator REMOVE PSU2 Pass.
    ...             fail_msg=Operator REMOVE UPSU2 Fail.
    Sleep      1   

Silverstone_LK_prepare_BI
    log.debug               Interaction Initialize prepare unit.
