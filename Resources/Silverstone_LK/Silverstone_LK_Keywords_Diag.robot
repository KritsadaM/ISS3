...
Download_File_to_unit
    ...
    ...                                  wait_for=#
    ...                                  expect_string=100%
    TELNET_Send_Command_expect_prompt    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r emadmin@192.168.1.230:/tftpboot/IMG_R4009-F9001-01_R06/R4009-JF002-01_Silverstone_B2F_BMCV2.02.ima /home/cel_diag/silverstone/firmware/bmc    password
    Diag_Telnet_Execute_Command          command=em4dmin    
    ...                                  wait_for=#
    ...                                  expect_string=100%
    ...
    Diag_Telnet_Execute_Command          command=md5sum /home/cel_diag/silverstone/firmware/bmc/R4009-JF002-01_Silverstone_B2F_BMCV2.02.ima
    ...                                  wait_for=#
    ...                                  expect_string=b601ab0e80d73f9617bba1df157ab77f
