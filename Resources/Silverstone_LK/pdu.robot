...
Power_Off_apc_1
    ...
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    APC_TELNET_CONN_OPEN
    # Telnet_Set_APC_command                          \r                              APC>
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    Telnet_Set_APC_command                          off ${psu1_outlet}              APC>
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    log.debug                                       Sending command: "exit"
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    Telnet.Write                                    exit
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    Telnet.Read
    Run Keyword If     '${logop}' != 'FCT' and '${logop}' != 'FCT_AUDIT' and '${logop}' != 'DEV'    WTI_TELNET_CONN_OPEN
    Run Keyword If     '${logop}' != 'FCT' and '${logop}' != 'FCT_AUDIT' and '${logop}' != 'DEV'    Telnet_Set_APC_command                          ${psu1_outlet} off             >
...
Power_Off_apc_2
    ...
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    APC_TELNET_CONN_OPEN
    # Telnet_Set_APC_command                          \r                              APC>
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    Telnet_Set_APC_command                          off ${psu2_outlet}              APC>
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    log.debug                                       Sending command: "exit"
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    Telnet.Write                                    exit
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    Telnet.Read
    Run Keyword If     '${logop}' != 'FCT' and '${logop}' != 'FCT_AUDIT' and '${logop}' != 'DEV'    WTI_TELNET_CONN_OPEN
    Run Keyword If     '${logop}' != 'FCT' and '${logop}' != 'FCT_AUDIT' and '${logop}' != 'DEV'    Telnet_Set_APC_command                          ${psu2_outlet} off             >
    Telnet.Close Connection
    sleep   40
...
Power_Off_UUT_1
    ...
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    APC_TELNET_CONN_OPEN
    # Telnet_Set_APC_command                          \r                              APC>
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    Telnet_Set_APC_command                          off ${Power_Control}            APC>
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    log.debug                                       Sending command: "exit"
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    Telnet.Write                                    exit
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    Telnet.Read
    Run Keyword If     '${logop}' != 'FCT' and '${logop}' != 'FCT_AUDIT' and '${logop}' != 'DEV'    WTI_TELNET_CONN_OPEN
    Run Keyword If     '${logop}' != 'FCT' and '${logop}' != 'FCT_AUDIT' and '${logop}' != 'DEV'    Telnet_Set_APC_command                          ${psu1_outlet} off             >
    Run Keyword If     '${logop}' != 'FCT' and '${logop}' != 'FCT_AUDIT' and '${logop}' != 'DEV'    Telnet.Close Connection
    Run Keyword If     '${logop}' != 'FCT' and '${logop}' != 'FCT_AUDIT' and '${logop}' != 'DEV'    WTI_TELNET_CONN_OPEN
    Run Keyword If     '${logop}' != 'FCT' and '${logop}' != 'FCT_AUDIT' and '${logop}' != 'DEV'    Telnet_Set_APC_command                          ${psu2_outlet} off             >
    Telnet.Close Connection
    sleep   40
...
Power_Cyling_Uninstall_ONIE
    ...
    # ${output}=      Telnet.Read Until    (y/n)
    # Telnet.Write Bare    y\r
    # ${output}=      Telnet.Read Until    password:
    ...
    ${out1}=    Telnet.Read Until    The highlighted entry will be executed automatically
    Save_to_logs        ${out1}\r
    ${status}   ${output}=  Run Keyword And Ignore Error    Should Not Contain    ${out1}    CLS Diag OS
    # Run Keyword If    '${status}' == 'FAIL'    Save_to_logs        ${out1}\r 
    Run Keyword If    '${status}' == 'FAIL'    log.debug    ----------------------------------------------------------------------------
    Run Keyword If    '${status}' == 'FAIL'    log.debug    Unexpect string "CLS Diag OS"
    Run Keyword If    '${status}' == 'FAIL'    log.debug    **** FAILED ****
    Run Keyword If    '${status}' == 'FAIL'    log.debug    ----------------------------------------------------------------------------
    Run Keyword If    '${status}' == 'FAIL'    FAIL     Uninstall not complete.
    log.debug    ----------------------------------------------------------------------------
    log.debug    Unexpect string "CLS Diag OS"
    log.debug    **** PASSED ****
    log.debug    ----------------------------------------------------------------------------
    ...
    sleep    1s  
    TELNET_CLOSE
    log.debug    Uninstall diag os successfully.
    # Telnet.Write    \r
    # ${out1}=    Telnet.Read Until    ONIE:/ #
    # Save_to_logs        ${out1}\r
...
Power_On_apc_1
    ...
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    APC_TELNET_CONN_OPEN
    # Telnet_Set_APC_command                          \r                              APC>
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    Telnet_Set_APC_command                          on ${psu1_outlet}              APC>
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    log.debug                                       Sending command: "exit"
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    Telnet.Write                                    exit
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    Telnet.Read
    Run Keyword If     '${logop}' != 'FCT' and '${logop}' != 'FCT_AUDIT' and '${logop}' != 'DEV'    WTI_TELNET_CONN_OPEN
    Run Keyword If     '${logop}' != 'FCT' and '${logop}' != 'FCT_AUDIT' and '${logop}' != 'DEV'    Telnet_Set_APC_command                          ${psu1_outlet} on             >
    Telnet.Close Connection
    sleep   5
...
Power_On_apc_2
    ...
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    APC_TELNET_CONN_OPEN
    # Telnet_Set_APC_command                          \r                              APC>
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    Telnet_Set_APC_command                          on ${psu2_outlet}              APC>
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    log.debug                                       Sending command: "exit"
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    Telnet.Write                                    exit
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    Telnet.Read
    Run Keyword If     '${logop}' != 'FCT' and '${logop}' != 'FCT_AUDIT' and '${logop}' != 'DEV'    WTI_TELNET_CONN_OPEN
    Run Keyword If     '${logop}' != 'FCT' and '${logop}' != 'FCT_AUDIT' and '${logop}' != 'DEV'    Telnet_Set_APC_command                          ${psu2_outlet} on             >
    Telnet.Close Connection
    sleep   5
...
Power_On_UUT_1
    ...
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    APC_TELNET_CONN_OPEN
    # Telnet_Set_APC_command                          \r                              APC>
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    Telnet_Set_APC_command                          on ${Power_Control}              APC>
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    log.debug                                       Sending command: "exit"
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    Telnet.Write                                    exit
    Run Keyword If     '${logop}' == 'FCT' or '${logop}' == 'FCT_AUDIT' or '${logop}' == 'DEV'    Telnet.Read
    Run Keyword If     '${logop}' != 'FCT' and '${logop}' != 'FCT_AUDIT' and '${logop}' != 'DEV'    WTI_TELNET_CONN_OPEN
