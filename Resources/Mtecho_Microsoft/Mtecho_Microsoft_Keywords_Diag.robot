...
Check_ODC_Patrameter_Robot_Debug
    ...
    END
    ${FAN_TYPE}=    Get Substring    ${serial_number}    5    8
    Set Global Variable    ${FAN_TYPE}
    Save_to_logs    Cell = "${slot_location}"\n
    Save_to_logs    FAN_TYPE = "${FAN_TYPE}"\n
...
Diag_BIOS_Image_Upgrade
    Diag_Telnet_Execute_Command                 command=cd /home/cel_diag/purestoragep2
    ...                                         wait_for=#
    Diag_Telnet_Execute_Command                 command=./bin/cel-upgrade-test --update -d 2 -f firmware/bios/${BIOS_File_Name}
    ...                                         wait_for=Enter your Option :
    Diag_Telnet_Execute_Command                 command=y
    ...                                         expect_string=Upgrade Firmware --> Passed
    ...                                         wait_for=Upgrade Firmware --> Passed
    ...                                         time_out=600
    Sleep   20s
    Diag_Telnet_Execute_Command                 command=cd /home/cel_diag/purestoragep2
    ...                                         wait_for=#
    Diag_Telnet_Execute_Command                 command=./bin/cel-upgrade-test --update -d 3 -f firmware/bios/${BIOS_File_Name}
    ...                                         wait_for=Enter your Option :
    Diag_Telnet_Execute_Command                 command=y
    ...                                         expect_string=Upgrade Firmware --> Passed
    ...                                         wait_for=Upgrade Firmware --> Passed
    ...
    Diag_Telnet_Execute_Command_12              command=ipmitool raw 0x3a 0x25 01
    Command_Power_Cyling_2                      ipmitool power cycle
    Diag_Telnet_Execute_Command_12              command=dmidecode -t bios | grep Version
    ...                                         expect_string=${Firmware_Version.Bios_Version}
    Diag_Telnet_Execute_Command_12              command=ipmitool raw 0x3a 0x25 00
    Diag_Login_And_Connect
...
Diag_CPLD_Image_Upgrade
    Diag_Telnet_Execute_Command                 command=cd /home/cel_diag/purestoragep2
    ...                                         wait_for=#
    Diag_Telnet_Execute_Command                 command=./bin/cel-upgrade-test --update -d 4 -f firmware/cpld/${CPLD_File_Name}
    ...                                         wait_for=Enter your Option :
    Diag_Telnet_Execute_Command                 command=y
    ...                                         expect_string=Upgrade Firmware --> Passed
    ...                                         wait_for=Upgrade Firmware --> Passed
...
Diag_Modify_CPU_MAC_address_check
    ...
    ${loop_count2}     Evaluate     ${MACADDRESS}+1
    ${loop_count3}     Evaluate     ${MACADDRESS}+2
    ${Mac2}    Convert To HEX    ${loop_count2}
    ${Mac3}    Convert To HEX    ${loop_count3}
    ${Maccount2}      Get Length     ${Mac2}
    ${Maccount3}      Get Length     ${Mac3}
    ${Mac_count2}    Evaluate    12-${Maccount2}
    ${Mac_count3}    Evaluate    12-${Maccount3}
    ${Mac_count2}=    Get Substring    ${MAC}    0    ${Mac_count2}
    ${Mac_count3}=    Get Substring    ${MAC}    0    ${Mac_count3}
    ${Mac2}    Set Variable If    '12' != '${Maccount2}'    ${Mac_count2}${Mac2}    ${Mac2}
    ${Mac3}    Set Variable If    '12' != '${Maccount3}'    ${Mac_count3}${Mac3}    ${Mac3}
    Set Global Variable     ${Mac2}
    Set Global Variable     ${Mac3}
    log.debug    The mac1 is: ${MAC}\n
    log.debug    The mac2 is: ${Mac2}\n
    log.debug    The mac3 is: ${Mac3}\n

    Diag_Telnet_Execute_Command_12              command=./tools/eeupdate64e /NIC=1 /MAC_DUMP
    ...                                         expect_string=${Mac2}
    Diag_Telnet_Execute_Command_12              command=./tools/eeupdate64e /NIC=2 /MAC_DUMP
    ...                                         expect_string=${Mac3}
...
Pre_program_BMC
    log.debug    ***** Start pre Program BMC to reduce noise of fan full speed *****\n
    Diag_Telnet_Execute_Command_12              command=ls
    ...                                         expect_string=fru_cfg
    ...                                         path=/home/cel_diag/purestoragep2/firmware/fru_eeprom
    ...
    ...                                         expect_string=Passed
    log.debug    ***** End pre Program BMC to reduce noise of fan full speed *****\n
...
Diag_Modify_CPU_MAC_address_test
    ...
    Diag_Telnet_Execute_Command_12              command=./tools/eeupdate64e /nic=1 /mac=${Mac2}
    ...                                         parse_string=${Mac2}.+Done,Checksum.+Done
    Diag_Telnet_Execute_Command_12              command=./tools/eeupdate64e /nic=2 /mac=${Mac3}
    ...                                         parse_string=${Mac3}.+Done,Checksum.+Done
    Diag_Login_And_Connect
    Diag_Telnet_Execute_Command_12              command=./tools/eeupdate64e /NIC=1 /MAC_DUMP
    ...                                         expect_string=${Mac2}
    Diag_Telnet_Execute_Command_12              command=./tools/eeupdate64e /NIC=2 /MAC_DUMP
...
Diag_SMBIOS_FRU_Burning
    ...
    ...                                         parse_string=Programming passed
    Diag_Telnet_Execute_Command_12              command=./bin/cel-eeprom-test --fru -w -t smbios -d 1 --item "System Version" -D "${TLA_REV}"
    ...                                         parse_string=Programming passed
    ...
    # ...                                         parse_string=Programming passed
    # Diag_Telnet_Execute_Command_12              command=./bin/cel-eeprom-test --fru -w -t system -d 1 --item "Board Version" -D "${TLA_REV}"
    # ...                                         parse_string=Programming passed
    ...
    # ...                                 ${PN},${TLA_REV},${MAC},${SMBios_Version.Board_Asset_Tag},${SMBios_Version.Board_Location_Chassis},${SMBios_Version.Chassis_Manufacturer},
...
EEPROM_CHECK_TEST_FOR_SMBIOS_FRU_testcase
    ...
    # Should Match Regexp    ${console}    System Version \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ : \ \ \ \ \ ${TLA_REV}
...
EEPROM_CHECK_TEST_FOR_BMC_FRU_testcase
    ...
    ...                                         parse_string=Board Mfg .+: Celestica,Board Product.+: Silverstone,Board Serial.+: ${BMC_SN},Board Part Number.+${BMC_PN},Board Extra.+: ${BMC_REV},Board Extra.+: ${BMC_Mac},Board Extra.+: ${UUID},Board Extra.+: Silverstone-BMC,Board Extra.+: ${PRODUCT_PN},Board Extra.+: ${TLA_REV}
    Diag_Telnet_Execute_Command_12              command=./bin/cel-eeprom-bmc-test -r -t system
    ...                                         parse_string=Board Mfg.+: Celestica,Board Product.+: Base Board,Board Serial.+: ${BASE_BOARD_SN},Board Part Number.+: ${BASE_BOARD_PN},Board Extra.+: Silverstone-baseboard,Board Extra.+: ${BASE_BOARD_REV},Product Manufacturer.+Celestica,Product Name.+: Silverstone,Product Part Number.+: ${PRODUCT_PN},Product Version.+: ${TLA_REV},Product Serial.+: ${TLA_SN},Product Extra.+: ${FAN_TYPE},Product Extra.+: ${MAC},Product Extra.+: 262
    Diag_Telnet_Execute_Command_12              command=./bin/cel-eeprom-bmc-test -r -t come
    ...                                         parse_string=Board Mfg.+Celestica,Board Product.+: COMe CPU Board,Board Serial.+: ${COME_SN},Board Part Number.+: ${COME_PN},Board Extra.+: Silverstone COME,Board Extra.+: ${COME_REV}
...
Diag_TLV_eeprom_programming
    ...
    ...                                         parse_string=Programming passed
    Run Keyword If     'B2F' == '${FAN_TYPE}'   Diag_Telnet_Execute_Command_12              command=./bin/cel-eeprom-test -w -t tlv -d 1 -A 0xFD -D "${TLV_Version.Vendor_B2F}"
                                                ...                                         parse_string=Programming passed
    Run Keyword If     'F2B' == '${FAN_TYPE}'   Diag_Telnet_Execute_Command_12              command=./bin/cel-eeprom-test -w -t tlv -d 1 -A 0xFD -D "${TLV_Version.Vendor_F2B}"
                                                ...                                         parse_string=Programming passed
    ${TLV_Version.Vendor_B2F}     Convert To Lower Case     ${TLV_Version.Vendor_B2F}
    ${TLV_Version.Vendor_F2B}     Convert To Lower Case     ${TLV_Version.Vendor_F2B}
    Run Keyword If     'B2F' == '${FAN_TYPE}'   Diag_Telnet_Execute_Command_12              command=./bin/cel-eeprom-test --dump -t tlv -d 1
    ...
    Run Keyword If     'F2B' == '${FAN_TYPE}'   Diag_Telnet_Execute_Command_12              command=./bin/cel-eeprom-test --dump -t tlv -d 1
                                                ...                                         parse_string=Product Name.+${TLV_Version.Product_Name},${TLA_PN},${TLA_SN},${MACADD},${TLV_TIME_GET},Device Version.+${TLA_REV},Label.+${TLV_Version.Product_Name},${TLV_Version.Platform_Name},${TLV_Version.ONIE_Version},MAC.+${TLV_Version.MAC_Addresses},Manufacturer.+${TLV_Version.Manufacturer},${TLV_Version.Country_Code},Vendor Name.+${TLV_Version.Manufacturer},${TLV_Version.Diag_Version},${TLV_Version.Service_tag},${TLV_Version.Vendor_F2B}
...
Diag_Eeprom_BMC_FRU_Test
    ...
    ${BMC_config}               Diag_Telnet_Execute_Command_12              command=cat bmc.cfg
                                ...                                         path=/home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg
    ...
    log.debug    ${Fanboard_config}\n
    Diag_Telnet_Execute_Command_12              command=rm /home/cel_diag/purestoragep2/firmware/fru_eeprom/*.bin
    # Diag_Telnet_Execute_Command_12              command=cp /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/Master_fan_board.cfg /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/fan_board.cfg
    # Diag_Telnet_Execute_Command_12              command=cp /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/Master_bmc.cfg /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/bmc.cfg
    # Diag_Telnet_Execute_Command_12              command=cp /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/Master_system.cfg /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/system.cfg
    # Diag_Telnet_Execute_Command_12              command=cp /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/Master_come.cfg /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/come.cfg
    # Diag_Telnet_Execute_Command_12              command=cp /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/Master_switch.cfg /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/switch.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${Fanboard_config}[0]/mfg_datetime=${Time_Stamp_test_result}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/fan_board.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${Fanboard_config}[1]/manufacturer=Celestica/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/fan_board.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${Fanboard_config}[2]/product_name=Fan control Board/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/fan_board.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${Fanboard_config}[3]/serial_number=${FAN_BOARD_SN}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/fan_board.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${Fanboard_config}[4]/part_number=${FAN_BOARD_PN}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/fan_board.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${Fanboard_config}[5]/board_custom_1=${FAN_BOARD_REV}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/fan_board.cfg    
    Diag_Telnet_Execute_Command_12              command=sed 's/${BMC_config}[0]/mfg_datetime=${Time_Stamp_test_result}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/bmc.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${BMC_config}[1]/manufacturer=Celestica/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/bmc.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${BMC_config}[2]/serial_number=${BMC_SN}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/bmc.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${BMC_config}[3]/part_number=${BMC_PN}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/bmc.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${BMC_config}[4]/customer_1=${BMC_REV}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/bmc.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${BMC_config}[5]/customer_2=${BMC_Mac}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/bmc.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${BMC_config}[6]/customer_3=${UUID}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/bmc.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${BMC_config}[7]/customer_4=NA/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/bmc.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${BMC_config}[8]/product_mfg=Silverstone-BMC/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/bmc.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${BMC_config}[9]/product_name=Silverstone/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/bmc.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${BMC_config}[10]/product_part_num=${PRODUCT_PN}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/bmc.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${BMC_config}[11]/product_ver=${TLA_REV}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/bmc.cfg    
    Diag_Telnet_Execute_Command_12              command=sed 's/${System_config}[0]/mfg_datetime=${Time_Stamp_test_result}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/system.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${System_config}[1]/manufacturer=Celestica/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/system.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${System_config}[2]/product_name=Base Board/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/system.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${System_config}[3]/serial_number=${BASE_BOARD_SN}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/system.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${System_config}[4]/part_number=${BASE_BOARD_PN}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/system.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${System_config}[5]/customer_1=Silverstone-baseboard/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/system.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${System_config}[6]/customer_2=${BASE_BOARD_REV}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/system.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${System_config}[7]/manufacturer=Celestica/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/system.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${System_config}[8]/product_name=Silverstone/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/system.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${System_config}[9]/part_number=${PRODUCT_PN}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/system.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${System_config}[10]/version=${TLA_REV}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/system.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${System_config}[11]/serial_number=${TLA_SN}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/system.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${System_config}[12]/customer_3=${FAN_TYPE}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/system.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${System_config}[13]/customer_4=${MAC}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/system.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${System_config}[14]/customer_5=262/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/system.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${ComE_config}[0]/mfg_datetime=${Time_Stamp_test_result}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/come.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${ComE_config}[1]/manufacturer=Celestica/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/come.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${ComE_config}[2]/product_name=COMe CPU Board/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/come.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${ComE_config}[3]/serial_number=${COME_SN}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/come.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${ComE_config}[4]/part_number=${COME_PN}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/come.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${ComE_config}[5]/customer_1=Silverstone COME/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/come.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${ComE_config}[6]/customer_2=${COME_REV}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/come.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${Switch_config}[0]/mfg_datetime=${Time_Stamp_test_result}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/switch.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${Switch_config}[1]/manufacturer=Celestica/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/switch.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${Switch_config}[2]/product_name=Switch Board/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/switch.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${Switch_config}[3]/serial_number=${SWITCH_BOARD_SN}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/switch.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${Switch_config}[4]/part_number=${SWITCH_BOARD_PN}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/switch.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/${Switch_config}[5]/customer_1=${SWITCH_BOARD_REV}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/switch.cfg
    # CONVERT_FAN_PN
    ...
    # ...                                         expect_string=Passed
    # Diag_Telnet_Execute_Command_12              command=rm /home/cel_diag/purestoragep2/firmware/fru_eeprom/bin/*.bin
    # Diag_Telnet_Execute_Command_12              command=rm /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/fan*.cfg
    # Diag_Telnet_Execute_Command_12              command=rm /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/bmc.cfg
    # Diag_Telnet_Execute_Command_12              command=rm /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/system.cfg
    # Diag_Telnet_Execute_Command_12              command=rm /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/come.cfg
    # Diag_Telnet_Execute_Command_12              command=rm /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/switch.cfg
    ...
    # Should Match Regexp    ${console}    Board Extra \ \ \ \ \ \ \ \ \ \ : F2B
    # Should Match Regexp    ${console}    Board Extra \ \ \ \ \ \ \ \ \ \ : A00
    Diag_Telnet_Execute_Command_12              command=./bin/cel-eeprom-bmc-test -r -t psu1
    ...                                         parse_string=${PSU1_SN}
    Diag_Telnet_Execute_Command_12              command=./bin/cel-eeprom-bmc-test -r -t psu2
    ...                                         parse_string=${PSU2_SN}
    log.debug    ******* CHECK EEPROM BMC *******
    log.debug    BMC SN\ \ \ \ \ \ : ${BMC_SN}
    log.debug    BMC PN\ \ \ \ \ \ : ${BMC_PN}
    log.debug    BMC REV : ${BMC_REV}
...
EEPROM_FAN
    ...
    sleep    2s
    Diag_Telnet_Execute_Command_12              command=rm /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/fan${command1}.cfg
    Diag_Telnet_Execute_Command_12              command=cp /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/Master_fan.cfg /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/fan${command1}.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/LINE1/mfg_datetime=${command4}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/fan${command1}.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/LINE2/manufacturer=Celestica/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/fan${command1}.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/LINE3/product_name=Fan Board/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/fan${command1}.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/LINE4/serial_number=${command2}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/fan${command1}.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/LINE5/part_number=${command3}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/fan${command1}.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/LINE6/customer_1=${Fan_Rev}/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/fan${command1}.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/LINE7/customer_2=F2B/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/fan${command1}.cfg
    Diag_Telnet_Execute_Command_12              command=sed 's/LINE8/customer_3=A00/g' -i /home/cel_diag/purestoragep2/firmware/fru_eeprom/fru_cfg/fan${command1}.cfg
...
Diag_Component_EEPROM_Programing
    ...
    Diag_Telnet_Execute_Command_12              command=./bin/cel-eeprom-bmc-test -k -t bmc -A p-9 -D ${TLA_REV}
    Diag_Telnet_Execute_Command_12              command=./bin/cel-eeprom-bmc-test -r -t bmc
    ...                                         parse_string=Passed,${BMC_SN},${BMC_PN},${BMC_Mac},${UUID},${PN},Product Extra.+${TLA_REV},Board Extra.+${BMC_Rev}
    ...
    Diag_Telnet_Execute_Command_12              command=./bin/cel-eeprom-bmc-test -k -t system -A p-3 -D ${TLA_REV}
    ...
    Diag_Telnet_Execute_Command_12              command=./bin/cel-eeprom-bmc-test -r -t system
    ...                                         parse_string=Passed,${Board_SN},${Board_PN},Board Extra.+${Board_Rev},${PN},Product Version.+${TLA_REV},${SN},${Type_Board},${MACADD}
...
Diag_CPLD_and_FPGA_access_test
    ...
    ...                                         expect_string=Passed
    Diag_Telnet_Execute_Command_12              command=./bin/cel-cpld-test -r -d 2 -R 1
    ...                                         expect_string=Passed
...
Diag_FAN_CPLD_access_test
    ...
    Diag_Telnet_Execute_Command_12              command=ipmitool raw 0x3a 0x26 0x01 0x00
    sleep    1s
    ...
    ...                                         expect_string=read Passed
    sleep    1s
    Diag_Telnet_Execute_Command_12              command=ipmitool raw 0x3a 0x26 0x01 0x01
    sleep    5s
...
Diag_QSFP_Control_test
    ...
    ...                                         unexpect_string=qsfp_reset : 0,qsfp_reset : 0,qsfp_modprs : 1,qsfp_lpmode : 1,sfp_modabs : 1,sfp_rxlos : 1,sfp_txdisable : 1,sfp_txfault : 1

Diag_SFP_and_QSFP_EEPROM_test
    Diag_Telnet_Execute_Command_12              command=./bin/cel-qsfp-test --all
    ...                                 unexpect_string=absent,Absent
    ...                                         parse_string=QSFP_ 1.+present,QSFP_ 2.+present,QSFP_ 3.+present,QSFP_ 4.+present,QSFP_ 5.+present,QSFP_ 6.+present,QSFP_ 7.+present,QSFP_ 8.+present,QSFP_ 9.+present,QSFP_10.+present,QSFP_11.+present,QSFP_12.+present,QSFP_13.+present,QSFP_14.+present,QSFP_15.+present,QSFP_16.+present,QSFP_17.+present,QSFP_18.+present,QSFP_19.+present,QSFP_20.+present,QSFP_21.+present,QSFP_22.+present,QSFP_23.+present,QSFP_24.+present,QSFP_25.+present,QSFP_26.+present,QSFP_27.+present,QSFP_28.+present,QSFP_29.+present,QSFP_30.+present,QSFP_31.+present,QSFP_32.+present,SFP_ 1.+present,SFP_ 2.+present
...
Diag_PSU_test_1
    ...
    # ...                                 wait_for=#
    Diag_Telnet_Execute_Command         command=ipmitest sdr elist | grep _Status
    ...                                         parse_string=PSU1_Status.+ok.+Presence detected,PSU2_Status.+ok
    ...                                         unparse_string=PSU2_Status.+ok.+Presence detected
    ...                                 wait_for=#
...
Diag_PSU_test_2
    ...
    # ...                                 wait_for=#
    Diag_Telnet_Execute_Command         command=ipmitest sdr elist | grep _Status
    ...                                         parse_string=PSU1_Status.+ok,PSU2_Status.+ok.+Presence detected
    ...                                         unparse_string=PSU1_Status.+ok.+Presence detected
    ...                                 wait_for=#
...
Diag_Fan_Speed_Test
    Run Keyword If     'B2F' == '${FAN_TYPE}'   Diag_Telnet_Execute_Command_12              command=./bin/cel-fan-test --all
                                                ...                                         parse_string=Fan Test all Passed,Fan1.+B2F,Fan2.+B2F,Fan3.+B2F,Fan4.+B2F,Fan5.+B2F,Fan6.+B2F,Fan7.+B2F,PSU.+Fan1.+B2F,PSU.+Fan2.+B2F
                                                ...                                         time_out=300
    Run Keyword If     'F2B' == '${FAN_TYPE}'   Diag_Telnet_Execute_Command_12              command=./bin/cel-fan-test --all
                                                ...                                         parse_string=Fan Test all Passed,Fan1.+F2B,Fan2.+F2B,Fan3.+F2B,Fan4.+F2B,Fan5.+F2B,Fan6.+F2B,Fan7.+F2B,PSU.+Fan1.+F2B,PSU.+Fan2.+F2B
                                                ...                                         time_out=300
    # Diag_Telnet_Execute_Command_12              command=./bin/cel-fan-test --all
    # ...                                         expect_string=Fan Test all Passed
    # ...                                         time_out=300
    # FOR     ${i}    IN RANGE    1   17
    #     Diag_Telnet_Execute_Command_12              command=./bin/cel-fan-test -S -d ${i} -D 20
    #     ...                                         expect_string=Passed
    # END
    # FOR     ${i}    IN RANGE    1   17
    #     Diag_Telnet_Execute_Command_12              command=./bin/cel-fan-test -r -d ${i}
    #     ...                                         expect_string=Read \ fan \ Passed
    # END
    # FOR     ${i}    IN RANGE    1   17
    #     Diag_Telnet_Execute_Command_12              command=./bin/cel-fan-test -S -d ${i} -D 50
    #     ...                                         expect_string=Passed
    # END
    # FOR     ${i}    IN RANGE    1   17
    #     Diag_Telnet_Execute_Command_12              command=./bin/cel-fan-test -r -d ${i}
    ...
    # END
    # FOR     ${i}    IN RANGE    1   17
    #     Diag_Telnet_Execute_Command_12              command=./bin/cel-fan-test -S -d ${i} -D 100
    #     ...                                         expect_string=Passed
    # END
    # FOR     ${i}    IN RANGE    1   17
    #     Diag_Telnet_Execute_Command_12              command=./bin/cel-fan-test -r -d ${i}
...
Diag_edit_cpu_yaml
    ...
    ${CPU_yaml}             Diag_Telnet_Execute_Command_12              command=cat /home/cel_diag/purestoragep2/diag_configs/cpu.yaml
    ...
    Diag_Telnet_Execute_Command_12              command=sed 's/${core_yaml}[0]${SPACE*2}${core_yaml}[1]/${core_yaml}[0]${SPACE*2}${core_cpu}/g' -i /home/cel_diag/purestoragep2/diag_configs/cpu.yaml
    Diag_Telnet_Execute_Command_12              command=sed 's/${version_cpu__yaml}/"${version_cpu}"/g' -i /home/cel_diag/purestoragep2/diag_configs/cpu.yaml
    Diag_Telnet_Execute_Command_12              command=cat /home/cel_diag/purestoragep2/diag_configs/cpu.yaml
...
Diag_Fan_BMC_test_F2B
    ...
    Save_to_logs        ${output}
    SSH_Send_Diag       /home/cel_diag/purestoragep2/bin
    ${output}=          SSHLibrary.Write    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@192.168.1.249:/tftpboot/cel-fan-ipmi-test /home/cel_diag/purestoragep2/bin
    Save_to_logs        ${output}
    ${status}   ${output}=  Run Keyword And Ignore Error    SSHLibrary.Read Until    password
    SSHLibrary.Write Bare    ${PASSWORD_server}\r\n
...
Diag_PHY_test
    ...
    # ${output}=          SSHLibrary.Write    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@192.168.1.249:/tftpboot/phy.yaml_1000_1 /home/cel_diag/midstone100X/diag_configs/phys.yaml
    # Save_to_logs        ${output}
    # ${status}   ${output}=  Run Keyword And Ignore Error    SSHLibrary.Read Until    password
    # SSHLibrary.Write Bare    ${PASSWORD_server}\r\n
    # ${status}   ${output}=  Run Keyword And Ignore Error    SSHLibrary.Read Until    Diag#
    ...
    # Save_to_logs        ${output}
    # SSH_Send_Diag       cd /home/FW/
    # ${output}=          SSHLibrary.Write    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@192.168.1.249:/tftpboot/phy.yaml_100_1 /home/cel_diag/midstone100X/diag_configs/phys.yaml
    # Save_to_logs        ${output}
    # ${status}   ${output}=  Run Keyword And Ignore Error    SSHLibrary.Read Until    password
    # SSHLibrary.Write Bare    ${PASSWORD_server}\r\n
    # ${status}   ${output}=  Run Keyword And Ignore Error    SSHLibrary.Read Until    Diag#
...
Diag_BMC_I2C_test
    ...
    ...                                         time_out=300
    Diag_Telnet_Execute_Command_12              command=./bin/cel-i2c-bmc-test -r -d 7 -A 0x0d -R 0x32 -C 1
    # ...                                         expect_string=0x7f
...
Diag_Sysinfo_test
    ...
    # ...                                         expect_string=${Firmware_Version.CPLD_ComE}
    Diag_Telnet_Execute_Command_12              command=./bin/cel-i2c-bmc-test -r -d 1 -A 0x0d -R 0xe0 -C 1
    ...                                         expect_string=${Firmware_Version.CPLD_ComE}
...
SDK_Load_SDK
    TELNET_Send_Command_expect_prompt           cd /home/cel_sdk/purestoragep2/${SDK_path}    \#
...
SDK_PRBS_Test
    ...
    SSH_Send_traffic                            sleep 120    200s
...
SDK_10G_SFP_port_Test
	...
	FOR     ${i}    IN RANGE    11
        ...
        SSH_Send_traffic    sleep 40
    END
    SSH_Send_traffic                            xe_port_cfg.soc
    SSH_Send_traffic                            clear c
    TELNET_Send_Command_expect_prompt           sh      \#
    ${output}       TELNET_Send_Command_expect_prompt           ./xeloopback.sh     \#
    SSH_Send_traffic                            exit
    TELNET_Send_Command_expect_prompt           exit    \#
    ${status}   ${output}=  Run Keyword And Ignore Error    Should Match Regexp    ${output}        result.+Passed
    Run Keyword If      '${status}' == 'PASS'    log.debug    ***************************************************\n
    Run Keyword If      '${status}' == 'PASS'    log.debug    TX packet == RX packet ---> Passed \n
    Run Keyword If      '${status}' == 'PASS'    log.debug    ***************************************************\n
    Run Keyword If      '${status}' == 'FAIL'    TX packet == RX packet ---> Failed \n
...
SDK_PCIE_FW_Update_Test
    TELNET_Send_Command_expect_prompt    cd /home/cel_sdk/purestoragep2/${SDK_path}    \#
    TELNET_Send_Command_expect_prompt    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@${local_host_ip}:${File_path}DVN-R4009-00031/pciefw-r5_v2p10.bin /home/cel_sdk/purestoragep2/${SDK_path}    password
    Diag_Telnet_Execute_Command          command=${PASSWORD_server}    
    ...                                  wait_for=#
    ...                                  expect_string=100%
    TELNET_Send_Command_expect_prompt           cd /home/cel_sdk/purestoragep2/${SDK_path}    \#
    TELNET_Send_Command_expect_prompt           ./auto_load_user.sh    BCM.0>
    SSH_Send_traffic    pciephy fw version
    ${console}=         SSH_Send_traffic    pciephy fw load pciefw-r5_v2p10.bin
    ...
    TELNET_Send_Command_expect_prompt           exit    \#
    ${status}           ${output}=          Run Keyword And Ignore Error    Should Contain      ${console}          2.10
    Run Keyword If     '${status}' == 'FAIL'    FAIL    PCIE Firmware Version Incorrect 2.10
    ${status}           ${output}=          Run Keyword And Ignore Error    Should Contain      ${console}          D102_0B
    Run Keyword If     '${status}' == 'FAIL'    FAIL    PCIE Firmware Version Incorrect D102_0B

SDK_PCIE_FW_Update_Test_BI
    # TELNET_Send_Command_expect_prompt    cd /home/cel_sdk/purestoragep2    \#
    # TELNET_Send_Command_expect_prompt    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@${local_host_ip}:/tftpboot/Pure_Storage/pcieg3fw.bin /home/cel_sdk/purestoragep2    password
    # Diag_Telnet_Execute_Command          command=${PASSWORD_server}    
    # ...                                  wait_for=#
    # ...                                  expect_string=100%
    TELNET_Send_Command_expect_prompt           cd /home/cel_sdk/purestoragep2/${SDK_path}    \#
...
Download_File_to_unit
    # TELNET_Send_Command_expect_prompt    cd /home/cel_sdk/purestoragep2    \#
    TELNET_Send_Command_expect_prompt    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@${local_host_ip}:${File_path}DVN-R4009-00028/cel-led-ipmi-test /home/cel_diag/purestoragep2/bin/    password
    Diag_Telnet_Execute_Command          command=${PASSWORD_server}    
    ...                                  wait_for=#
    ...                                  expect_string=100%
    TELNET_Send_Command_expect_prompt    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@${local_host_ip}:${File_path}DVN-R4009-00028/cel-led-test /home/cel_diag/purestoragep2/bin/    password
    Diag_Telnet_Execute_Command          command=${PASSWORD_server}    
    ...                                  wait_for=#
    ...                                  expect_string=100%
    TELNET_Send_Command_expect_prompt    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@${local_host_ip}:${File_path}DVN-R4009-00028/cel-upgrade-test /home/cel_diag/purestoragep2/bin/    password
    Diag_Telnet_Execute_Command          command=${PASSWORD_server}    
    ...                                  wait_for=#
    ...                                  expect_string=100%
    TELNET_Send_Command_expect_prompt    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@${local_host_ip}:${File_path}DVN-R4009-00028/leds.yaml /home/cel_diag/purestoragep2/diag_configs    password
    Diag_Telnet_Execute_Command          command=${PASSWORD_server}    
    ...                                  wait_for=#
    ...                                  expect_string=100%
    TELNET_Send_Command_expect_prompt    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@${local_host_ip}:${File_path}DVN-R4009-00028/i2cs_ipmi.yaml /home/cel_diag/purestoragep2/diag_configs    password
    Diag_Telnet_Execute_Command          command=${PASSWORD_server}    
    ...                                  wait_for=#
    ...                                  expect_string=100%
    TELNET_Send_Command_expect_prompt    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@${local_host_ip}:${File_path}${FPGA_File_Name} /home/cel_diag/purestoragep2/firmware/fpga    password
    Diag_Telnet_Execute_Command          command=${PASSWORD_server}    
    ...                                  wait_for=#
    ...                                  expect_string=100%
    TELNET_Send_Command_expect_prompt    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@${local_host_ip}:${File_path}${BIOS_File_Name} /home/cel_diag/purestoragep2/firmware/bios    password
    Diag_Telnet_Execute_Command          command=${PASSWORD_server}    
    ...                                  wait_for=#
    ...                                  expect_string=100%
    TELNET_Send_Command_expect_prompt    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@${local_host_ip}:${File_path}${CPLD_File_Name} /home/cel_diag/purestoragep2/firmware/cpld    password
    Diag_Telnet_Execute_Command          command=${PASSWORD_server}    
    ...                                  wait_for=#
    ...                                  expect_string=100%
    TELNET_Send_Command_expect_prompt    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@${local_host_ip}:${File_path}${BMC_File_Name} /home/cel_diag/purestoragep2/firmware/bmc    password
    Diag_Telnet_Execute_Command          command=${PASSWORD_server}    
    ...                                  wait_for=#
    ...                                  expect_string=100%
    TELNET_Send_Command_expect_prompt    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@${local_host_ip}:${File_path}DVN-R4009-00030/cel-cpld-ipmi-test /home/cel_diag/purestoragep2/bin/    password
    Diag_Telnet_Execute_Command          command=${PASSWORD_server}    
    ...                                  wait_for=#
    ...                                  expect_string=100%
    TELNET_Send_Command_expect_prompt    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@${local_host_ip}:${File_path}DVN-R4009-00030/upgrade.yaml /home/cel_diag/purestoragep2/diag_configs    password
    Diag_Telnet_Execute_Command          command=${PASSWORD_server}    
    ...                                  wait_for=#
    ...                                  expect_string=100%
    Diag_Telnet_Execute_Command          command=md5sum /home/cel_diag/purestoragep2/bin/cel-led-ipmi-test
    ...                                  wait_for=#
    ...                                  expect_string=351f6b1d1fb23e5b071b4bae7bbc874a
    Diag_Telnet_Execute_Command          command=md5sum /home/cel_diag/purestoragep2/bin/cel-led-test
    ...                                  wait_for=#
    ...                                  expect_string=1e0dd442801f7df717d05aa00b6051ec
    Diag_Telnet_Execute_Command          command=md5sum /home/cel_diag/purestoragep2/bin/cel-upgrade-test
    ...                                  wait_for=#
    ...                                  expect_string=42e2ae8c8b02ff0c41125179f6188433
    Diag_Telnet_Execute_Command          command=md5sum /home/cel_diag/purestoragep2/bin/cel-cpld-ipmi-test
    ...                                  wait_for=#
    ...                                  expect_string=5779e157b1f5ef3d1f9bef916b205c54
    Diag_Telnet_Execute_Command          command=md5sum /home/cel_diag/purestoragep2/diag_configs/upgrade.yaml
    ...                                  wait_for=#
    ...                                  expect_string=d350f142bb5b9642a348fa54dcea4aab
    Diag_Telnet_Execute_Command          command=md5sum /home/cel_diag/purestoragep2/diag_configs/leds.yaml
    ...                                  wait_for=#
    ...                                  expect_string=44e6a2596be5fb1d0ebe716d7b335009
    Diag_Telnet_Execute_Command          command=md5sum /home/cel_diag/purestoragep2/diag_configs/i2cs_ipmi.yaml
    ...                                  wait_for=#
    ...                                  expect_string=68b609bffe8b101a06620af2dc9dcd3c
    Diag_Telnet_Execute_Command          command=md5sum /home/cel_diag/purestoragep2/firmware/fpga/${FPGA_File_Name}
    ...                                  wait_for=#
    ...                                  expect_string=${FPGA_File_size}
    Diag_Telnet_Execute_Command          command=md5sum /home/cel_diag/purestoragep2/firmware/bios/${BIOS_File_Name}
    ...                                  wait_for=#
    ...                                  expect_string=${BIOS_File_size}
    Diag_Telnet_Execute_Command          command=md5sum /home/cel_diag/purestoragep2/firmware/cpld/${CPLD_File_Name}
    ...                                  wait_for=#
    ...                                  expect_string=${CPLD_File_size}
    Diag_Telnet_Execute_Command          command=md5sum /home/cel_diag/purestoragep2/firmware/bmc/${BMC_File_Name}
    ...                                  wait_for=#
    ...                                  expect_string=${BMC_File_size}
    ${SDK_name}    Replace String    ${SDK_path}    .    _
    Diag_Telnet_Execute_Command_12       command=mv ${SDK_path}.zip ${SDK_name}.zip
    ...                                  path=/home/cel_sdk/purestoragep2
    Diag_Telnet_Execute_Command_12       command=unzip ${SDK_name}.zip -d /home/cel_sdk/purestoragep2/
    ...                                  path=/home/cel_sdk/purestoragep2
...
Diag_ETH_test 
    Diag_Telnet_Execute_Command_12          command=ifconfig ma1 ${SSH_IP} up
    Diag_Telnet_Execute_Command_12          command=ping ${SSH_IP} -c5
    ...                                     expect_string=5 received
    Swap_BMC
    Diag_Telnet_Execute_BMC                 command=ifconfig eth0 ${BMC_IP_2} up
    sleep  5
    Diag_Telnet_Execute_BMC                 command=ping ${BMC_IP_2} -c 5
    ...                                     expect_string=5 received
    Swap_COME
    # # Power_Cyling
...
Diag_SPD_memory_test 
    ...
    Save_to_logs        ${output}
    SSH_Send_Diag       cd /home/FW/
    ${output}=          SSHLibrary.Write    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@192.168.1.249:/tftpboot/mem.yaml/ /home/cel_diag/midstone100X/diag_configs
    Save_to_logs        ${output}
    ${status}   ${output}=  Run Keyword And Ignore Error    SSHLibrary.Read Until    password
    SSHLibrary.Write Bare    ${PASSWORD_server}\r\n
    ${status}   ${output}=  Run Keyword And Ignore Error    SSHLibrary.Read Until    Diag#
...
Diag_SHOW_SENSOR_testcase
    sleep    60s
    log.debug     sleep 60s
    @{search_list}=     Create List     TEMP_FB_U52  TEMP_FB_U17  TEMP_CPU  TEMP_SW_Internal  TEMP_SW_U52  TEMP_SW_U16  TEMP_DIMM0
    ...                                 TEMP_DIMM1  BMC_XP3R3V  BMC_XP2R5V  BMC_XP1R2V  BMC_XP1R15V  BB_XP12R0V  BB_XP5R0V
    ...                                 COME_XP3R3V  COME_XP1R82V  COME_XP1R05V  COME_XP1R7V  COME_XP1R2V  COME_XP1R3V  COME_XP1R5V  COME_XP2R5V
    ...                                 SW_XP3R3V_EARLY  SW_VDD_CORE  SW_XP0R8V  SW_XP3R3V_R  SW_XP3R3V_L  SW_XP1R8V  SW_XP1R2V  SW_XP1R2V_FPGA
    ...                                 SW_XP1R0V_FPGA  SW_XP1R8V_FPGA  SW_XP3R3V  SW_PVDD0P8  PSU1_VIn  PSU1_CIn  PSU1_PIn  PSU1_Fan  PSU1_Temp1  PSU1_Temp2
    ...                                 PSU1_Temp3  PSU1_VOut  PSU1_COut  PSU1_POut  PSU2_VIn  PSU2_CIn  PSU2_PIn  PSU2_Fan  PSU2_Temp1  PSU2_Temp2
    ...                                 PSU2_Temp3  PSU2_VOut  PSU2_COut  PSU2_POut  Fan1_Front  Fan2_Front  Fan3_Front  Fan4_Front  Fan5_Front  Fan6_Front
    ...                                 Fan7_Front  Fan1_Rear  Fan2_Rear  Fan3_Rear  Fan4_Rear  Fan5_Rear  Fan6_Rear  Fan7_Rear  SW_U04_VIn  SW_U04_CIn
    ...                                 SW_U04_PIn  SW_U04_Temp  SW_U04_VOut  SW_U04_COut  SW_U04_POut  SW_U4403_VIn1  SW_U4403_CIn1  SW_U4403_PIn1
    ...                                 SW_U4403_Temp  SW_U4403_VOut1  SW_U4403_COut1  SW_U4403_POut1  SW_U14_VIn  SW_U14_CIn  SW_U14_PIn
    ...                                 SW_U14_Temp  SW_U14_VOut  SW_U14_COut  SW_U14_POut
...
Diag_SDK_Function_Test
    TELNET_Send_Command_expect_prompt    cd /home/cel_sdk/purestoragep2/${SDK_path}    \#
    TELNET_Send_Command_expect_prompt    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@${local_host_ip}:/tftpboot/eBay/pcieg3fw.bin /home/cel_sdk/purestoragep2/${SDK_path}    password
    Diag_Telnet_Execute_Command          command=${PASSWORD_server}    
    ...                                  wait_for=#
    ...                                  expect_string=100%
    Diag_Telnet_Execute_Command_12      command=md5sum pciefw-r5.bin
...
Diag_PCIE_DMA_Stress_Test
    ...
    SSH_Send_Diag    exit
    SSH_Send_Diag    \r
    SSH_Send_Diag    cd /home/cel_diag/purestoragep2  
...
Diag_ONIE_Function_test
    ...
    ...                                     expect_string=${TLA_PN},${TLA_SN},${MACADD}
    Diag_ONIE_MANAGEMENT_PORT_test
    TELNET_OPEN     ${time_out}
    Telnet.Write Bare    ssh root@${SSH_IP}\n
    Save_to_logs    ${SPACE} ssh root@${SSH_IP}\n
    log.debug       Telnet Sending command "ssh root@${SSH_IP}"\n
    ${status}   ${output}=  Run Keyword And Ignore Error    Telnet.Read Until    (y/n)
    Save_to_logs       ${output}\r
    Telnet.Write Bare    y\n
    log.debug       Telnet Sending command "y"\n
    Save_to_logs       ${SPACE}y\r
...
Diag_NOS_Install
    ...
    ${output}=    SSHLibrary.Write    yes | scp -r ${USERNAME_server}@192.168.1.249:/tftpboot/New_Version/R3250-J0011-01_V2.0.1_Midstone100X_SONiC/onie-installer-x86_64-cel_midstone-100x-r0.bin /
    Save_to_logs       ${output}\r
    ...
    ...                              wait_for=ONIE:/ #
    ${output}=    SSHLibrary.Write Bare    ${PASSWORD_server}\r\n
    Save_to_logs       ${output}\r
...
Diag_NOS_Install2
    ...
    ${status}    Power_Cyling_Install_ONIE
    Run Keyword If    '${status}' == 'FAIL'    UUT_Boot_Into_ONIE
    Run Keyword If    '${status}' == 'FAIL'    Diag_Nos_install_ONL

Diag_Nos_install_ONL
    [Arguments]    ${time_out}=90s
    Diag_Telnet_ONIE_Command      command=onie-discovery-stop
    TELNET_OPEN     ${time_out}
    Telnet.Write    ssh root@${SSH_IP}
    ${output}=    Telnet.Write    ifconfig eth0 ${SSH_IP} up
    Save_to_logs       ${output}\r
    Telnet.Read Until    ONIE:/ #
    ${status}   ${output}=  Run Keyword And Ignore Error    Telnet.Read Until    ONIE:/ #
    Save_to_logs       ${output}\r
    ${output}=    Telnet.Write Bare    yes | scp -r ${USERNAME_server}@${local_host_ip}:${File_path}${ONL_file_name} /\n
    Save_to_logs       ${output}\r
    Telnet.Read Until    ONIE:/ #
    ${status}   ${output}=  Run Keyword And Ignore Error    Telnet.Read Until    (y/n)
    Save_to_logs       ${output}\r
    ${output}=    Telnet.Write Bare    y\n
    Save_to_logs       ${output}\r
    ${status}   ${output}=  Run Keyword And Ignore Error    Telnet.Read Until    password
    Save_to_logs       ${output}\r
    ${output}=    Telnet.Write Bare    ${PASSWORD_server}\n
    Save_to_logs       ${output}\r
    ${status}   ${output}=  Run Keyword And Ignore Error    Telnet.Read Until    ONIE:/ #
    Save_to_logs       ${output}\r
    ${output}=    Telnet.Write Bare    cd /\n
    Save_to_logs       ${output}\r
    ${status}   ${output}=  Run Keyword And Ignore Error    Telnet.Read Until    ONIE:/ #
    Save_to_logs       ${output}\r
    ${output}=    Telnet.Write Bare    md5sum ${ONL_file_name}\n
    Save_to_logs       ${output}\r
    ${status}   ${output}=  Run Keyword And Ignore Error    Telnet.Read Until    ONIE:/ #
    Save_to_logs       ${output}\r
    ${status}   ${output}=  Run Keyword And Ignore Error    Should Contain     ${output}    ${ONL_File_size}
    Run Keyword If    '${status}' == 'FAIL'    Telnet.Write Bare    rm ${ONL_file_name}\n
    Run Keyword If    '${status}' == 'FAIL'    FAIL
    TELNET_CLOSE
    Run Keyword If    '${status}' == 'PASS'    Reboot_Install_ONIE
    # Run Keyword If    '${status}' == 'FAIL'    START_SSH_ONIE_Tranfer_File_1
...
Diag_NOS_Install1
    ...
    Save_to_logs       ${output}\r
    ${output}=    SSHLibrary.Write    ${PASSWORD_server}
    Save_to_logs       ${output}\r
    ${output}=    SSHLibrary.Read Until    ONIE:/ #
    Save_to_logs       ${output}\r
    ${output}=    SSHLibrary.Write    cd /
...
Download_Diag
    TELNET_Send_Command_expect_prompt    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@${local_host_ip}:${File_path}${Diag_File} /home/    password
    Diag_Telnet_Execute_Command          command=${PASSWORD_server}    
    ...                                  wait_for=#
    ...                                  expect_string=100%
...
Install_Diag
    ...
    Diag_Telnet_Execute_Command_12       command=./diag.sh
    ...                                  path=/home/cel_diag/purestoragep2
...
Diag_SSH_Execute_Command
    [Arguments]    ${wait_before_send}=0.5ms     ${open_conn}=False   ${close_con}=False    ${command}=default    ${path}=/home/cel_diag/purestoragep2
...
Diag_SSH_ONIE_Execute_Command
    [Arguments]    ${wait_before_send}=0.5ms     ${open_conn}=False   ${close_con}=False    ${command}=default    ${path}=/home/cel_diag/purestoragep2/bin
...
Diag_Telnet_Execute_Command
    [Arguments]    ${wait_before_send}=0.5ms     ${open_conn}=False   ${close_con}=False    ${command}=default   ${unparse_string}=default
...
Diag_SSH_Into_Telnet_Execute_Command
    [Arguments]    ${wait_before_send}=0.5ms     ${open_conn}=False   ${close_con}=False    ${command}=default
...
Diag_Check_Unexpect_string
    ...
    FOR   ${i}  IN  @{unexpect_list}
        ...
        log.newline
        log.debug      ----------------------------------------------------------------------------
        log.debug      The phrase "${i}" is not in LOG check
        log.debug      **** PASSED ****
        log.debug      ----------------------------------------------------------------------------\n
    END
...
Diag_SSH_DC_DC_Controller_Access_test
    [Arguments]    ${wait_before_send}=0.5ms     ${open_conn}=False   ${close_con}=False    ${command}=default    ${path}=/root/diag/   ${V1MAX}=default    ${V2MAX}=default    ${V3MAX}=default    ${V1MIN}=default    ${V2MIN}=default    ${V3MIN}=default
...
Download_Image
    ...
    Save_to_logs        ${output}
    SSH_Send_Diag       cd /home/FW/
    ${output}=          SSHLibrary.Write    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@192.168.1.249:/tftpboot/New_FW_Midstone/BIOS/ /home/FW/
    Save_to_logs        ${output}
    ${status}   ${output}=  Run Keyword And Ignore Error    SSHLibrary.Read Until    password
    SSHLibrary.Write Bare    ${PASSWORD_server}\r\n
    ${status}   ${output}=  Run Keyword And Ignore Error    SSHLibrary.Read Until    Diag#
    ${output}=          SSHLibrary.Write    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@192.168.1.249:/tftpboot/New_FW_Midstone/BMC/ /home/FW/
    Save_to_logs        ${output}
    ${status}   ${output}=  Run Keyword And Ignore Error    SSHLibrary.Read Until    password
    SSHLibrary.Write Bare    ${PASSWORD_server}\r\n
    ${status}   ${output}=  Run Keyword And Ignore Error    SSHLibrary.Read Until    Diag#
    ${output}=          SSHLibrary.Write    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@192.168.1.249:/tftpboot/New_FW_Midstone/FPGA/ /home/FW/
    Save_to_logs        ${output}
    ${status}   ${output}=  Run Keyword And Ignore Error    SSHLibrary.Read Until    password
    SSHLibrary.Write Bare    ${PASSWORD_server}\r\n
    ${status}   ${output}=  Run Keyword And Ignore Error    SSHLibrary.Read Until    Diag#
    ${output}=          SSHLibrary.Write    scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r ${USERNAME_server}@192.168.1.249:/tftpboot/New_FW_Midstone/CPLD/ /home/FW/
    Save_to_logs        ${output}
    ${status}   ${output}=  Run Keyword And Ignore Error    SSHLibrary.Read Until    password
    SSHLibrary.Write Bare    ${PASSWORD_server}\r\n
    ${status}   ${output}=  Run Keyword And Ignore Error    SSHLibrary.Read Until    Diag#
...
Swap_BMC
    Util_Test_Execution         test_case=Swap_BMC_1
    ...                         retry_loop=4
...
Swap_COME
    Util_Test_Execution         test_case=Swap_COME_1
    ...                         retry_loop=4
...
TG_Port_Start
    ...
    TELNET_CLOSE
    log.debug  sending command ->${TF_Port_400G}_clear\n
    TELNET_Send_Command_TG_prompt    ${TF_Port_400G}_clear
    log.debug  sending command ->${TF_Port_400G}_start\n
    TELNET_Send_Command_TG_prompt    ${TF_Port_400G}_start
...
TG_Port_Stop
    ...
    Run Keyword If    '${status}' == 'FAIL'    FAIL     Log-in TG
    TELNET_CLOSE
    log.debug  sending command ->${TF_Port_400G}_stop\n
    TELNET_Send_Command_TG_prompt    ${TF_Port_400G}_stop
    sleep    5s
    TELNET_Send_Command_TG_prompt    ${TF_Port_400G}_show
    Create File    /opt/Sync/Sync_TG.txt    Done
...
Sync_Step_start
    [Arguments]    ${time_out}=400s
    log.debug  Wait Sync to Install ONL\n
    log.debug  ********************************\n
    Wait Until Created    /opt/Sync/Sync_Install.txt    60min
    log.debug  Sync to Install ONL Start\n
    Remove Files    /opt/Sync/Sync_Install.txt
    # log.debug  Log out to Traffic generator\n
    # log.debug  ********************************\n

Sync_Step_stop
    [Arguments]    ${time_out}=400s
    Create File    /opt/Sync/Sync_Install.txt    Done
    log.debug  ********************************\n
    log.debug  Sync to Install ONL Stop\n