...
Pure_Storage_prepare_BI
    log.debug               Interaction Initialize prepare unit.
    USER_INTERACTION        title=Inserted QSFP, Ethernet cable Console and USB. 
    ...             question_msg=Inserted QSFP, Ethernet cable Console and USB. 
    ...             image_name=SilverStoneLK_Setup.jpg      retry=12h      retry_interval=2s
    ...             html=user_interaction.html
    ...             pass_msg=Operator Inserted QSFP, Ethernet cable Console and USB Pass.
    ...             fail_msg=Operator Inserted QSFP, Ethernet cable Console and USB Fail.
    Sleep      1  
...
MtEcho_port_white
    log.debug               Interaction white LED check.
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-test -w -t sff -D white
    ...                                 expect_string=Passed
    USER_INTERACTION        title=PORT LED white ?
    ...             question_msg=Are all PORT LED is white ?
    ...             image_name=MtEcho_port_white.JPG      retry=12h      retry_interval=2s
    ...             html=user_interaction.html
    ...             pass_msg=Operator all PORT LED is white Pass.
    ...             fail_msg=Operator all PORT LED is white Fail.
    Sleep      1   

MtEcho_port_yellow
    log.debug               Interaction yellow LED check.
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-test -w -t sff -D yellow
    ...                                 expect_string=Passed
    USER_INTERACTION        title=PORT LED yellow ?
    ...             question_msg=Are all PORT LED is yellow ?
    ...             image_name=MtEcho_port_yellow.JPG      retry=12h      retry_interval=2s
    ...             html=user_interaction.html
    ...             pass_msg=Operator all PORT LED is yellow Pass.
    ...             fail_msg=Operator all PORT LED is yellow Fail.
    Sleep      1   

MtEcho_port_magenta
    log.debug               Interaction magenta LED check.
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-test -w -t sff -D magenta
    ...                                 expect_string=Passed
    USER_INTERACTION        title=PORT LED magenta ?
    ...             question_msg=Are all PORT LED is magenta ?
    ...             image_name=MtEcho_port_magenta.JPG      retry=12h      retry_interval=2s
    ...             html=user_interaction.html
    ...             pass_msg=Operator all PORT LED is magenta Pass.
    ...             fail_msg=Operator all PORT LED is magenta Fail.
    Sleep      1   
...
MtEcho_front_led_alm_blink
    ...
    ...                                 expect_string=Amber_Blink_1_Hz
...
MtEcho_front_led_alm_blink_sta_blink
    ...
    ...                                 expect_string=Alternate_Blink_1_Hz
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t led -d 2 -D Amber_Blink_1_Hz
    ...                                 expect_string=Amber_Blink_1_Hz
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t led -d 3 -D off
    ...                                 expect_string=off
...
MtEcho_fan_led_off
    ...
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t fan -d 1 -D off
    ...                                 expect_string=off
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t fan -d 2 -D off
    ...                                 expect_string=off
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t fan -d 3 -D off
    ...                                 expect_string=off
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t fan -d 4 -D off
    ...                                 expect_string=off
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t fan -d 5 -D off
    ...                                 expect_string=off
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t fan -d 6 -D off
    ...                                 expect_string=off
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t fan -d 7 -D off
    ...                                 expect_string=off
...
MtEcho_fan_led_red
    ...
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t fan -d 1 -D red
    ...                                 expect_string=red
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t fan -d 2 -D red
    ...                                 expect_string=red
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t fan -d 3 -D red
    ...                                 expect_string=red
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t fan -d 4 -D red
    ...                                 expect_string=red
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t fan -d 5 -D red
    ...                                 expect_string=red
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t fan -d 6 -D red
    ...                                 expect_string=red
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t fan -d 7 -D red
    ...                                 expect_string=red
...
MtEcho_fan_led_green
    ...
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t fan -d 1 -D green
    ...                                 expect_string=green
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t fan -d 2 -D green
    ...                                 expect_string=green
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t fan -d 3 -D green
    ...                                 expect_string=green
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t fan -d 4 -D green
    ...                                 expect_string=green
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t fan -d 5 -D green
    ...                                 expect_string=green
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t fan -d 6 -D green
    ...                                 expect_string=green
    Diag_Telnet_Execute_Command_12            command=./bin/cel-led-ipmi-test -w -t fan -d 7 -D green
    ...                                 expect_string=green
